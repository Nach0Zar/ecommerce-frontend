  ...
  return (
    <div id="containerAboutus">
        ...
        <div className="textBlock mb-3">
                ...
                Así, en 1999, mientras estudiaba en la Universidad de Stanford, Estados Unidos, Marcos Galperin y un puñado de emprendedores pusieron en marcha el proyecto de revolucionar el comercio en América Latina a través de la tecnología. Así nació Zona Compra, una empresa que ya recorrió 21 años, opera en 18 países y llegó a cotizar en Nasdaq sin perder nunca su corazón de start up.
                Esa cultura emprendedora está en nuestro ADN y su efecto multiplicador escribe la historia de nuestro crecimiento. Es el espíritu que impulsa la misión de Zona Compra, que es democratizar el comercio electrónico y los servicios financieros en la región para transformar la vida de millones de personas en América Latina.
        ...
        <div className="textBlock mb-4">
            Como Empresa nos comprometemos a la mision de no solo brindar el mejor servicio de compras virtuales a nivel sudamerica si no que nos comprometemos a nivel sociedad brindando gran cantidad de empleos, tanto en el área de desarrollo como en la de envios y venta de articulos. Es nuestra responsabilidad la creación de nuevos puestos de trabajo
